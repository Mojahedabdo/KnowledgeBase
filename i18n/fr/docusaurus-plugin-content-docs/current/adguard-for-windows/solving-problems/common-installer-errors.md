...
- Démarrez et réenregistrez le service Microsoft Installer. Ceci nécessite du travail.
    ...
    1) Appuyez sur *Win + R* et saisissez **services.msc**. 2) Trouvez dans la liste et double-cliquez sur *Windows Installer*. 3) Appuyez sur le bouton *Démarrer* sous *État du service* et appuyez sur *OK*. Si l'état du service est **en cours d'exécution**, vous devez d'abord cliquer sur *Arrêter* puis appuyer sur *Démarrer*. 4) Appuyez sur *Win + R*, tapez et saisissez ***msiexec /unregister*** et appuyez sur *Entrée*. 5) Appuyez à nouveau sur *Win + R*, tapez et saisissez ***msiexec /regserver*** et appuyez sur *Entrée*
...
- Obtenez les autorisations complètes sur le lecteur pour l’installation. Il est possible que l'erreur 1603 se produise parce que vous n'avez pas toutes les autorisations sur l'emplacement du fichier. Ce n’est pas non plus aussi simple que certaines des autres solutions :
    ...
    1) Ouvrez *l'Explorateur de fichiers*, faites un clic droit sur le lecteur contenant l'emplacement d'installation et sélectionnez *Propriétés*. 2) Allez dans l'onglet *Sécurité* et cliquez sur *Modifier*. 3) Faites un clic simple sur *SYSTEM* et assurez-vous que la case *Autoriser* de chaque élément des *Autorisations pour SYSTEM* est cochée (si elle est cochable). Faites la même vérification pour les *Administrateurs*. 4) Cliquez sur *OK* pour revenir à la boîte de dialogue des *Propriétés*. Ensuite, cliquez sur *Avancés*. 5) Cliquez sur *Modifier les autorisations*. 6) Sur l'onglet *Autorisations*, double-cliquez sur *Administrateurs*. 7) Sélectionnez *Ce dossier, sous-dossiers et fichiers* pour le champ *S'applique à* et cochez toutes les *autorisations de base* disponibles. Après cela, cliquez sur *OK*. 8) Faites la même opération ci-dessus (point 7) pour *SYSTEM*. 9) Cliquez sur *OK* jusqu'au bout. Essayez à nouveau d’installer AdGuard.
